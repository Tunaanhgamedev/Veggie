            ...
            <div class="col-lg-6 align-self-center">
                <div class="about-us-info-wrap">
                    <div class="section-title-area ltn__section-title-2">
                        ...
                        <h1 class="section-title">Cửa Hàng Thực Phẩm<br class="d-none d-md-block">Đáng Tin Cậy</h1>
                        <p>Chúng tôi cam kết cung cấp thực phẩm hữu cơ chất lượng, an toàn cho sức khỏe và tôn trọng môi
                            trường.</p>
                    </div>
                    <p>Các người bán mong muốn làm điều tốt, hành động có trách nhiệm và lan tỏa giá trị tích cực. Chúng
                        tôi là một
                        thị trường hai chiều, dân chủ và tự duy trì, phát triển dựa trên niềm tin, cộng đồng và nội dung
                        chất lượng.</p>
                    <div class="about-author-info d-flex">
                        <div class="author-name-designation  align-self-center">
                            <h4 class="mb-0">TunaMoi</h4>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 col-12">
                <div class="ltn__feature-item ltn__feature-item-7">
                    ...
                    <div class="ltn__feature-info">
                        <p>Các thương hiệu phong phú, đáp ứng đa dạng nhu cầu khách hàng với tiêu chuẩn chất lượng cao.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-12">
                <div class="ltn__feature-item ltn__feature-item-7">
                    ...
                    <div class="ltn__feature-info">
                        <p>Sản phẩm được chọn lọc kỹ lưỡng để đảm bảo độ tươi ngon và an toàn cho người tiêu dùng.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-12">
                <div class="ltn__feature-item ltn__feature-item-7">
                    ...
                    <div class="ltn__feature-info">
                        <p>Sản phẩm canh tác theo tiêu chuẩn an toàn, không sử dụng thuốc trừ sâu độc hại.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="ltn__team-area pt-115 pb-90">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title-area ltn__section-title-2 text-center">
                    <h1 class="section-title white-color---">Thành viên đội ngũ</h1>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="ltn__team-item">
                    ...
                    <div class="team-info">
                        <h6 class="ltn__secondary-color"> Người sáng lập </h6>
                        <h4><a href="team-details.html">TunaMoi</a></h4>
                        <div class="ltn__social-media">
                            <ul>
                                <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="#"><i class="fab fa-twitter"></i></a></li>
