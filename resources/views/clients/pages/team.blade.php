        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="ltn__team-item">
                    ...
                    <div class="team-info">
                        <h6 class="ltn__secondary-color">Nông dân trồng trọt</h6>
                        ...
                        <div class="col-xl-5 col-lg-12 align-self-center">
                            <div class="ltn__service-form-brief">
                                <div class="section-title-area ltn__section-title-2 mb-0">
                                    <h6 class="section-subtitle white-color">// Kêu gọi hành động</h6>
                                    <h1 class="section-title white-color">Nhận dịch vụ miễn phí từ chúng tôi.</h1>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <ul>
                                        <li>
                                            <select class="nice-select">
                                                ...
                                                <option>Thiết kế cảnh quan</option>
                                                <option>Chuẩn bị đất</option>
                                                <option>Trồng rau</option>
                                            </select>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <div class="btn-wrapper">
                                                <button type="submit"
                                                    class="btn theme-btn-1 btn-effect-1 text-uppercase">Kiểm tra
                                                    trạng thái</button>
                                            </div>
                                        </li>
                                    </ul>
            ...
            <div class="col-lg-6">
                <div class="ltn__progress-bar-wrap">
                    <div class="section-title-area ltn__section-title-2">
                        ...
                        <h1 class="section-title">Đội ngũ giàu kỹ năng của chúng tôi<span>.</span></h1>
                        <p>Đội ngũ của chúng tôi có chuyên môn sâu và nhiều năm kinh nghiệm trong lĩnh vực.</p>
                    </div>
