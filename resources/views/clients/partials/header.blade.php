            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="ltn__top-bar-menu">
                        <ul>
                            <li><a href="locations.html"><i class="icon-placeholder"></i> Lien Chieu, Da
                                    Nang</a></li>
                            <li><a href="mailto:anh2005qpqb@gmail.com?Subject=Contact%20with%20to%20you"><i
                                        class="icon-mail"></i> anh2005qpqb@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-5">
                        ...
                        <nav>
                            <div class="ltn__main-menu">
                                <ul>
                                    ...
                                    <li class="special-link"><a href="{{ route('about') }}">YÊU CẦU BÁO GIÁ</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                    ...
                    <div class="header-search-wrap">
                        ...
                        <div class="header-search-1-form">
                            <form id="#" method="GET" action="{{ route('search') }}">
                                <input type="text" name="keyword" value="" placeholder="Tìm kiếm ở đây..." />
