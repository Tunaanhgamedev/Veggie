            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-about-widget">
                        ...
                        <p>Chúng tôi là cửa hàng chuyên cung cấp thực phẩm hữu cơ, sạch và an toàn cho gia đình bạn.
                            Cam kết chất lượng, nguồn gốc rõ ràng và dịch vụ tận tâm.</p>
                        <div class="footer-address">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="footer-address-info">
                                        <p><a href="tel:+0123-456789">+84 123 456 789</a></p>
                                    </div>
                                </li>
                                <li>
                                    <div class="footer-address-icon">
                                    ...
                                    <div class="footer-address-info">
                                        <p><a href="mailto:anh2005qpqb@gmail.com">anh2005qpqb@gmail.com</a>
                                        </p>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="footer-widget footer-menu-widget clearfix">
                        ...
                        <div class="footer-menu">
                            <ul>
                                ...
                                <li><a href="{{ route('service') }}">Sản phẩm</a></li>
